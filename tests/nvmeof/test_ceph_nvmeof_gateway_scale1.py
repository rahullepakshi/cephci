"""
Test Module to configure NVMeOF GW entities.
"""
...
def run(ceph_cluster: Ceph, **kwargs) -> int:
                ...
                steps:
                    ...
                    - config:
                          ...
                          args:
                            ...
                            bdev: bdev1
    """
    LOG.info("Configure Ceph NVMeoF GW entities over CLI.")
    ...
    try:
        ...
        for step in steps:
            ...
            if command in ["create_bdev","add_namespace"]:
                if cfg["args"].pop("count"):
                    for num in range(cfg["args"].pop("count")):
